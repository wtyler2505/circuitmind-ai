...
- **In-Scope:**
  ...
  - Local-first data persistence via IndexedDB and Git-as-data.
- **Out-of-Scope:**
  - Cloud-only storage (unless explicitly requested for sync).
  - High-voltage power system simulation (>50V DC).
