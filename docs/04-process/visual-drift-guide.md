...
2. Check the checklist in `docs/04-process/component-checklist.md`.
3. Validate glass surface consistency with `docs/04-process/ui-tokens.md`.
4. Ensure empty states guide a next action.
5. Record any drift in `docs/03-logs/validation-log.md`.
