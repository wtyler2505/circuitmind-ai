...
- **Z-Indexing Layers**: 0. **Canvas**: `z-0` (Background) 10. **Header**: `z-10` (Floating top) 20. **Chat Panel**: `z-20` (Floating bottom) 40. **Inventory**: `z-40` (Slide-out sidebar) 50. **Modals**: `z-50` (Overlays)
